package io.github.lukeeey.benchkit.cloudburst.socket;

import com.google.gson.JsonObject;
import com.google.gson.JsonParser;
import io.github.lukeeey.benchkit.cloudburst.BenchkitPlugin;
import io.github.lukeeey.benchkit.cloudburst.socket.tasks.ApplyModelTask;
import io.github.lukeeey.benchkit.cloudburst.socket.tasks.ApplySkinTask;
import io.github.lukeeey.benchkit.cloudburst.socket.tasks.FetchPlayerListTask;
import io.github.lukeeey.benchkit.cloudburst.socket.tasks.SocketTask;
...
public class BlockbenchSocket extends WebSocketServer {
    ...
    public void onClose(WebSocket socket, int code, String reason, boolean remote) {
        plugin.getLogger().warn(code + " remote: " + remote + " - " + reason);
    ...
    public void onMessage(WebSocket socket, String message) {
        ...
        if (type.equalsIgnoreCase("authenticate")) {
            ...
            if (key.equalsIgnoreCase(plugin.getKey())) {
                ...
                plugin.getLogger().warn("Authenticated!");
            } else {
    ...
    public void onError(WebSocket socket, Exception e) {
        plugin.getLogger().warn("onError: " + e.getMessage());
    }

    @Override
    public void onStart() {
        plugin.getLogger().warn("onStart");
    }
}
